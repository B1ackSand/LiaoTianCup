...
using LiaoTian_Cup.Mode;

namespace LiaoTian_Cup.Overview
{
    /// <summary>
    /// ShowUSuckDetail.xaml 的交互逻辑
    /// </summary>
    public partial class ShowUSuckDetail : Page
    {
        private USuckModeWindow m_parent;

        public ShowUSuckDetail(USuckModeWindow parent)
        {
            m_parent = parent;
            InitializeComponent();
            showSelect();
